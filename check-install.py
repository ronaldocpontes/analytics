...
print "\n===================================================="
print "Required Packages works fine: You're all set."
print "====================================================\n\n"
...
# Testing ExcelReader
try:
    from pandas.io.parsers import ExcelReader
    print "ExcelReader is installed and can be imported"
except ImportError:
    print("Error : ExcelReader can not be imported or not installed.")
print
...
try:
    ...
    print "ExcelWriter is installed and can be imported"
except ImportError:
    print("Error : ExcelWriter can not be imported or not installed.")
print
